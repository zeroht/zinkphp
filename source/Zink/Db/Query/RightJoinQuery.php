...
class RightJoinQuery extends JoinQuery
{
    /**
    ...
    {
        $this->_initJoin($table, $otherTable, $localKey, $foreignKey, self::RIGHT_JOIN);
    }
}

/* End of file RightJoinQuery.php */
...
class SuggestController_1_1_0 extends BaseClientapiController
{
    /*
     * @api {post} /app/suggest/v1.1.0/submit 1.意见反馈
    ...
    public function submitAction()
    {
        ...
        if ($this->get('image_ids')) {
            $data['image_ids'] = $this->get('image_ids');
        }
